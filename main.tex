...
\simpleheader{titleBackColor!60}{Md}{Al-Mamun}{Python Developer | Data Analyst}{white}
...
Firstly, science helps our understanding of the world around us. Everything we know about the universe, from how trees reproduce to what an atom is made up of, is the result of scientific research and experiment. Human progress throughout history has largely rested on advances in science.\\\textbf{G.P.A: 3.29/5.00}}
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % Work Experience
        \section*{\textcolor{mitred}{{\faSuitcase} WORK EXPERIENCE}}
        ...
        \MySectionNoPic{\textcolor{mitgray}{2020-2022}}{Digital Marketing}{International}{\textbf{Fiverr}}{Here my technical work was to Developed and executed marketing programs and general business solutions resulting in increased
...
presentations, public relations campaigns, articles and newsletters.}  
        ...
        \MySectionNoPic{\textcolor{mitgray}{2023-Present}}{Data Engineering}{International}{\textbf{Upwork}}{Here I provide Analytical Expertise on Data analysis and Data manupulation. My technical are Data Visualization and Feature Engineering. I train Data by using ML technique for prediction and Other Services.}  
        \vspace*{0.6cm}
%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %Publications
        ...
        \publication{Thesis}{2022}{HMalware Detection using Machine Learning Model}{Md Al-Mamun, Md Redwan, Tamanna Zaman Tammi}{World University of Bangladesh}{Unpublished}
...
\sidebar{sideBarColor!20}
\newpageheader{mitgray}{Md}{Al-Mamun}{Python Developer 
